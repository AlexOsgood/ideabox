...
var whiteStar = document.querySelector('#star-button')
...
whiteStar.addEventListener('click', favoriteIdea)
redStar.addEventListener('click', unfavoriteIdea)
starBanner.addEventListener('click', eventProp)
...
savedIdeas.push(newIdea)
 ...
 `<div  id='full-idea' class='idea-card'>
   <section id='banner-star' class='star-banner'>
     <img class='red-star' 'child' src="assets/activestarred.png" alt="red star">
     <svg xmlns="http://www.w3.org/2000/svg" class='star' 'child' id="star-button" viewBox="0 0 16.06 15.65"><defs><style>.cls-1{fill:#fff;}</style></defs><title>Artboard 29</title><g id="background"><polygon class="cls-1" points="8.02 2.48 9.64 5.77 13.27 6.29 10.64 8.85 11.26 12.47 8.02 10.76 4.77 12.47 5.39 8.85 2.76 6.29 6.39 5.77 8.02 2.48"/></g></svg>
     <img class='delete-x' 'child' src="assets/deletex.png" alt="delete-x">
